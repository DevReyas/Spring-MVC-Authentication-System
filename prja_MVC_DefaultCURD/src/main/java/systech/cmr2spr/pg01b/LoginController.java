...
// mdl.addAttribute("abLLm", dm);
  ...
  public String logout(HttpServletRequest req, Model mdl) {
    ...
    return "pg01a.view.home"; // pgela.view.home.jsp

  }

  @RequestMapping("/pg01b.ctrl.updateuser")
  public String editur(HttpServletRequest req, Model mdl) {
...
boolean b3 = upwdn.length() < 3;
  ...
  @RequestMapping("/pg01b.ctrl.deluser")
  ...
  public String clients (HttpServletRequest req, Model mdl) {
    String stb1="<table width='100%'><thead>";
    stb1 += "<th align='left'>ID";
    stb1 += "<th align='left'>Password";
    stb1 += "<th align='left'>Status";
    ...
    stb1 += str;
    mdl.addAttribute("atbUsers", stb1);
    return "pg01b.view.users";
  }
